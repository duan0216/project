<template>
    <div class="shousuoBox">
        <div class="leftAside">
            ...
            <div class="analyBtn">
                <el-button type="primary" @click="analysis">查询<i v-show="showLoad" class="el-icon-loading"></i></el-button>
            </div>
        </div>
        <!--分析弹窗-->
            ...
            <template v-if="!showDetail">
              <div class="dialogBody" v-show="resultBodyVisible">
                <template v-if="!showChart">
                    ...
                    @click="handleFilter">过滤展示</el-button>
                    </div>
                    ...
                    <el-table stripe :data="tableData" height="100%" style="width: 100%;">
                        ...
                        <el-table-column :show-overflow-tooltip="true" align="center" prop="zldwdm" width="200" label="坐落单位代码" ></el-table-column>
              ...
              <div class="dialogFoot" v-show="resultBodyVisible">
                <div class="btnBox">
                    <el-button type="primary" size="mini" @click="searchChart" v-if="!showChart">分类统计</el-button>
                    <el-button size="mini" @click="handlechart" v-if="showChart">返回</el-button>
                </div>
              </div>
            </template>
            <!-- 查看详情 -->
              ...
              .then(res=>{
                ...
                .then(res=>{
                  ...
                  result.forEach(e=>{
                      ...
                      for (var key in res.data){
                        if(key == e.dlbm){
                          arr2.push({dlbm:res.data[key],yzmj:e.total})
                          flag = true
                        }
                      }
                      if(!flag){
                        arr2.push({dlbm:"其他",yzmj:e.total})
                      }
                  })
